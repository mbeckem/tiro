...
void Diagnostics::report(Level level, const AbsoluteSourceRange& range, std::string text) {
...
void Diagnostics::vreport(Level level, const AbsoluteSourceRange& range,
