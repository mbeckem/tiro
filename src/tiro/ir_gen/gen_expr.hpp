...
private:
    ...
    // Support function for the implementation of optional chaining. When `expr` evaluates to a non-null value,
    // the code generated by `compile_value` is invoked with that value. Otherwise, the null value propagates.
    // The returned local value is a represents both cases.
    LocalResult compile_optional(
