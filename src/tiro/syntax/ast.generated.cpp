// Automatically generated by ./utils/generate-ast at 2020-04-27 18:15:51.483107.
...
std::string_view to_string(NodeType type) {
    ...
    case NodeType::IndexExpr:
        return "IndexExpr";
    case NodeType::InterpolatedStringExpr:
...
void AssertStmt::message(Expr* value) {
    message_.reset(value);
}

Expr* AssertStmt::message() const {
    return message_;
}

DeclStmt::DeclStmt()
    : ASTStmt(NodeType::DeclStmt)
    , bindings_() {}
...
EmptyStmt::EmptyStmt()
    : ASTStmt(NodeType::EmptyStmt) {}

EmptyStmt::~EmptyStmt() {}

ExprStmt::ExprStmt()
    : ASTStmt(NodeType::ExprStmt)
    , expr_() {}
...
void Decl::declared_symbol(SymbolPtr value) {
    declared_symbol_ = value;
}

SymbolPtr Decl::declared_symbol() const {
...
void FuncDecl::body_is_value(const bool& value) {
    body_is_value_ = value;
}

const bool& FuncDecl::body_is_value() const {
...
void Expr::surrounding_scope(ScopePtr value) {
    surrounding_scope_ = value;
}

ScopePtr Expr::surrounding_scope() const {
...
InterpolatedStringExpr::InterpolatedStringExpr()
    : Expr(NodeType::InterpolatedStringExpr)
    , items_() {}

InterpolatedStringExpr::~InterpolatedStringExpr() {}

void InterpolatedStringExpr::items(ExprList* value) {
    items_.reset(value);
}

ExprList* InterpolatedStringExpr::items() const {
    return items_;
}
...
void VarExpr::resolved_symbol(SymbolPtr value) {
    resolved_symbol_ = value;
}

SymbolPtr VarExpr::resolved_symbol() const {
