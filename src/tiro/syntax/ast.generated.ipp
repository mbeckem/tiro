// Automatically generated by ./utils/generate-ast at 2020-03-21 23:25:54.779653.
...
#define TIRO_VISIT_CASE(CaseType, case_function)                          \
    case NodeType::CaseType: {                                            \
        if constexpr (std::is_base_of_v<T, CaseType>) {                   \
            return visitor.case_function(must_cast<CaseType>(node.get()), \
                std::forward<Arguments>(args)...);                        \
        }                                                                 \
        break;                                                            \
    }

        TIRO_VISIT_CASE(AssertStmt, visit_assert_stmt)
        TIRO_VISIT_CASE(DeclStmt, visit_decl_stmt)
        TIRO_VISIT_CASE(EmptyStmt, visit_empty_stmt)
        TIRO_VISIT_CASE(ExprStmt, visit_expr_stmt)
        TIRO_VISIT_CASE(ForStmt, visit_for_stmt)
        TIRO_VISIT_CASE(WhileStmt, visit_while_stmt)
        TIRO_VISIT_CASE(TupleBinding, visit_tuple_binding)
        TIRO_VISIT_CASE(VarBinding, visit_var_binding)
        TIRO_VISIT_CASE(BindingList, visit_binding_list)
        TIRO_VISIT_CASE(FuncDecl, visit_func_decl)
        TIRO_VISIT_CASE(ImportDecl, visit_import_decl)
        TIRO_VISIT_CASE(ParamDecl, visit_param_decl)
        TIRO_VISIT_CASE(VarDecl, visit_var_decl)
        TIRO_VISIT_CASE(BinaryExpr, visit_binary_expr)
        TIRO_VISIT_CASE(BlockExpr, visit_block_expr)
        TIRO_VISIT_CASE(BreakExpr, visit_break_expr)
        TIRO_VISIT_CASE(CallExpr, visit_call_expr)
        TIRO_VISIT_CASE(ContinueExpr, visit_continue_expr)
        ...
        TIRO_VISIT_CASE(FuncLiteral, visit_func_literal)
        TIRO_VISIT_CASE(IntegerLiteral, visit_integer_literal)
        TIRO_VISIT_CASE(MapLiteral, visit_map_literal)
        TIRO_VISIT_CASE(NullLiteral, visit_null_literal)
        TIRO_VISIT_CASE(SetLiteral, visit_set_literal)
        TIRO_VISIT_CASE(StringLiteral, visit_string_literal)
        TIRO_VISIT_CASE(SymbolLiteral, visit_symbol_literal)
        TIRO_VISIT_CASE(TupleLiteral, visit_tuple_literal)
        TIRO_VISIT_CASE(ReturnExpr, visit_return_expr)
        TIRO_VISIT_CASE(StringSequenceExpr, visit_string_sequence_expr)
        TIRO_VISIT_CASE(TupleMemberExpr, visit_tuple_member_expr)
        TIRO_VISIT_CASE(UnaryExpr, visit_unary_expr)
        TIRO_VISIT_CASE(VarExpr, visit_var_expr)
        TIRO_VISIT_CASE(ExprList, visit_expr_list)
        TIRO_VISIT_CASE(File, visit_file)
        TIRO_VISIT_CASE(MapEntry, visit_map_entry)
        TIRO_VISIT_CASE(MapEntryList, visit_map_entry_list)
        TIRO_VISIT_CASE(NodeList, visit_node_list)
        TIRO_VISIT_CASE(ParamList, visit_param_list)
        TIRO_VISIT_CASE(Root, visit_root)
        TIRO_VISIT_CASE(StmtList, visit_stmt_list)
        TIRO_VISIT_CASE(VarList, visit_var_list)
...
#define TIRO_VISIT_CASE(CaseType)                             \
    case NodeType::CaseType: {                                \
        ...
        TIRO_VISIT_CASE(AssertStmt)
        TIRO_VISIT_CASE(DeclStmt)
        TIRO_VISIT_CASE(EmptyStmt)
        TIRO_VISIT_CASE(ExprStmt)
        TIRO_VISIT_CASE(ForStmt)
        TIRO_VISIT_CASE(WhileStmt)
        TIRO_VISIT_CASE(TupleBinding)
        TIRO_VISIT_CASE(VarBinding)
        TIRO_VISIT_CASE(BindingList)
        TIRO_VISIT_CASE(FuncDecl)
        TIRO_VISIT_CASE(ImportDecl)
        TIRO_VISIT_CASE(ParamDecl)
        TIRO_VISIT_CASE(VarDecl)
        TIRO_VISIT_CASE(BinaryExpr)
        TIRO_VISIT_CASE(BlockExpr)
        TIRO_VISIT_CASE(BreakExpr)
        TIRO_VISIT_CASE(CallExpr)
        TIRO_VISIT_CASE(ContinueExpr)
        TIRO_VISIT_CASE(DotExpr)
        TIRO_VISIT_CASE(IfExpr)
        TIRO_VISIT_CASE(IndexExpr)
        TIRO_VISIT_CASE(InterpolatedStringExpr)
        TIRO_VISIT_CASE(ArrayLiteral)
        TIRO_VISIT_CASE(BooleanLiteral)
        TIRO_VISIT_CASE(FloatLiteral)
        TIRO_VISIT_CASE(FuncLiteral)
        TIRO_VISIT_CASE(IntegerLiteral)
        TIRO_VISIT_CASE(MapLiteral)
        TIRO_VISIT_CASE(NullLiteral)
        TIRO_VISIT_CASE(SetLiteral)
        TIRO_VISIT_CASE(StringLiteral)
        TIRO_VISIT_CASE(SymbolLiteral)
        TIRO_VISIT_CASE(TupleLiteral)
        TIRO_VISIT_CASE(ReturnExpr)
        TIRO_VISIT_CASE(StringSequenceExpr)
        TIRO_VISIT_CASE(TupleMemberExpr)
        TIRO_VISIT_CASE(UnaryExpr)
        TIRO_VISIT_CASE(VarExpr)
        TIRO_VISIT_CASE(ExprList)
        TIRO_VISIT_CASE(File)
        TIRO_VISIT_CASE(MapEntry)
        TIRO_VISIT_CASE(MapEntryList)
        TIRO_VISIT_CASE(NodeList)
        TIRO_VISIT_CASE(ParamList)
        TIRO_VISIT_CASE(Root)
        TIRO_VISIT_CASE(StmtList)
        TIRO_VISIT_CASE(VarList)
...
template<>
struct NodeTraits<ASTStmt> {
    static constexpr bool is_abstract = true;

    static constexpr NodeType first_node_type = NodeType::FirstASTStmt;
    static constexpr NodeType last_node_type = NodeType::LastASTStmt;

    template<typename Visitor>
    static void traverse_children(ASTStmt* node, Visitor&& visitor) {
        NodeTraits<Node>::traverse_children(node, visitor);
    }

    template<typename Transform>
    static void transform_children(ASTStmt* node, Transform&& transform) {
...
struct NodeTraits<AssertStmt> {
    ...
    static void traverse_children(AssertStmt* node, Visitor&& visitor) {
        NodeTraits<ASTStmt>::traverse_children(node, visitor);
    ...
    static void transform_children(AssertStmt* node, Transform&& transform) {
        NodeTraits<ASTStmt>::transform_children(node, transform);

        node->condition(must_cast_nullable<Expr>(transform(node->condition())));
        node->message(must_cast_nullable<Expr>(transform(node->message())));
    }
};
...
struct NodeTraits<StmtList> {
    ...
    static void traverse_children(StmtList* node, Visitor&& visitor) {
        NodeTraits<Node>::traverse_children(node, visitor);
        NodeListTraits<ASTStmt>::traverse_items(node, visitor);
    }

    template<typename Transform>
    static void transform_children(StmtList* node, Transform&& transform) {
        NodeTraits<Node>::transform_children(node, transform);
        NodeListTraits<ASTStmt>::transform_items(node, transform);
    }
};
