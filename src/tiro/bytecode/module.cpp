...
/* [[[cog
    import unions
    import bytecode
    unions.implement_type(bytecode.BytecodeMemberType)
]]] */
...
/* [[[cog
    import unions
    import bytecode
    unions.implement_type(bytecode.BytecodeMember)
]]] */
...
NotNull<IndexMapPtr<BytecodeMember>> BytecodeModule::
operator[](BytecodeMemberID id) {
    return TIRO_NN(members_.ptr_to(id));
}

NotNull<IndexMapPtr<const BytecodeMember>> BytecodeModule::
operator[](BytecodeMemberID id) const {
    return TIRO_NN(members_.ptr_to(id));
}

NotNull<IndexMapPtr<BytecodeFunction>> BytecodeModule::
operator[](BytecodeFunctionID id) {
    return TIRO_NN(functions_.ptr_to(id));
}

NotNull<IndexMapPtr<const BytecodeFunction>> BytecodeModule::
