#ifndef TIRO_COMPILER_SEMANTICS_SEMANTIC_CHECKER_HPP
#define TIRO_COMPILER_SEMANTICS_SEMANTIC_CHECKER_HPP
...
#endif // TIRO_COMPILER_SEMANTICS_SEMANTIC_CHECKER_HPP
