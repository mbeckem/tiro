...
/* [[[cog
    import unions
    import mir_transform
    unions.define_type(mir_transform.AssignTargetType)
]]] */
...
/* [[[cog
    ...
    cog.outl()
    unions.define_inlines(mir_transform.AssignTarget)
]]] */
template<typename Self, typename Visitor>
