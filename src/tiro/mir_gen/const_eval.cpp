...
static EvalResult
eval_plus(const Constant& lhs, const Constant& rhs) {
...
static EvalResult
eval_minus(const Constant& lhs, const Constant& rhs) {
    constexpr auto intop = [](i64 a, i64 b) -> EvalResult {
        SafeInt result = a;
        if (!result.try_sub(b))
            return EvalResult::make_integer_overflow();
...
static EvalResult
eval_multiply(const Constant& lhs, const Constant& rhs) {
    constexpr auto intop = [](i64 a, i64 b) -> EvalResult {
        SafeInt result = a;
        if (!result.try_mul(b))
            return EvalResult::make_integer_overflow();
...
static EvalResult
eval_divide(const Constant& lhs, const Constant& rhs) {
...
static EvalResult
eval_remainder(const Constant& lhs, const Constant& rhs) {
    static constexpr auto intop = [](i64 a, i64 b) -> EvalResult {
        if (b == 0)
            return EvalResult::make_divide_by_zero();
...
static EvalResult
eval_power(const Constant& lhs, const Constant& rhs) {
    constexpr auto intop = [](i64 a, i64 b) -> EvalResult {
        if (a == 0 && b < 0)
            return EvalResult::make_divide_by_zero();
        if (b == 0)
...
static EvalResult
eval_left_shift(const Constant& lhs, const Constant& rhs) {
...
static EvalResult
eval_right_shift(const Constant& lhs, const Constant& rhs) {
    return integer_op(lhs, rhs, [&](i64 a, i64 b) -> EvalResult {
        if (b < 0)
            return EvalResult::make_negative_shift();
        if (b > max_shift)
...
static EvalResult
eval_bitwise_and(const Constant& lhs, const Constant& rhs) {
    return integer_op(lhs, rhs, [&](i64 a, i64 b) { return make_int(a & b); });
}

static EvalResult
eval_bitwise_or(const Constant& lhs, const Constant& rhs) {
    return integer_op(lhs, rhs, [&](i64 a, i64 b) { return make_int(a | b); });
}

static EvalResult
eval_bitwise_xor(const Constant& lhs, const Constant& rhs) {
    return integer_op(lhs, rhs, [&](i64 a, i64 b) { return make_int(a ^ b); });
}

static EvalResult
eval_equals(const Constant& lhs, const Constant& rhs) {
    return make_bool(is_equal(lhs, rhs));
}

static EvalResult
eval_not_equals(const Constant& lhs, const Constant& rhs) {
    return make_bool(!is_equal(lhs, rhs));
}

template<typename Test>
static EvalResult numeric_compare(
    const Constant& lhs, const Constant& rhs, Test&& test) {
...
static EvalResult
eval_less(const Constant& lhs, const Constant& rhs) {
    return numeric_compare(lhs, rhs, [](int cmp) { return cmp < 0; });
}

static EvalResult
eval_less_equals(const Constant& lhs, const Constant& rhs) {
    return numeric_compare(lhs, rhs, [](int cmp) { return cmp <= 0; });
}

static EvalResult
eval_greater(const Constant& lhs, const Constant& rhs) {
    return numeric_compare(lhs, rhs, [](int cmp) { return cmp > 0; });
}
...
EvalResult
eval_unary_operation(UnaryOpType op, const Constant& value) {
    switch (op) {
#define TIRO_CASE(optype, func)    \
...
EvalResult
eval_format(Span<const Constant> operands, StringTable& strings) {
    struct Visitor {
