#ifndef TIRO_VM_OBJECTS_FUNCTIONS_IPP
#define TIRO_VM_OBJECTS_FUNCTIONS_IPP
...
struct Code::Data : Header {
    Data(Span<const byte> code_)
        ...
        TIRO_DEBUG_ASSERT(code_.size() <= std::numeric_limits<u32>::max(), "Code too large.");
...
#endif // TIRO_VM_OBJECTS_FUNCTIONS_IPP
