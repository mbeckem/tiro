#ifndef TIRO_VM_OBJECTS_STRINGS_HPP
#define TIRO_VM_OBJECTS_STRINGS_HPP
...
public:
    ...
    explicit StringBuilder(Value v)
        : Value(v) {
        TIRO_DEBUG_ASSERT(v.is<StringBuilder>(), "Value is not a string builder.");
    }
...
#endif // TIRO_VM_OBJECTS_STRINGS_HPP
