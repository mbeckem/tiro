// Automatically generated by ./utils/generate-ast at 2020-01-13 20:41:19.666846.
...
public:
    ...
    void observed(const bool& value);
    const bool& observed() const;
...
class FormatStringExpr final : public Expr {
public:
    explicit FormatStringExpr();
    ~FormatStringExpr();
...
public:
    ...
    // optional
    void message(StringLiteral* value);
...
public:
    ...
    HAMMER_VISITOR_DECL void visit_node(
        [[maybe_unused]] Node* node, [[maybe_unused]] Arguments... args) {}

    HAMMER_VISITOR_DECL void visit_binding(
    ...
    HAMMER_VISITOR_DECL void visit_var_binding(
    ...
    HAMMER_VISITOR_DECL void visit_dot_expr(
        [[maybe_unused]] DotExpr* node, [[maybe_unused]] Arguments... args) {
        derived().visit_expr(node, args...);
    }

    HAMMER_VISITOR_DECL void
    visit_format_string_expr([[maybe_unused]] FormatStringExpr* node,
        [[maybe_unused]] Arguments... args) {
        derived().visit_expr(node, args...);
    }

    HAMMER_VISITOR_DECL void visit_if_expr(
        [[maybe_unused]] IfExpr* node, [[maybe_unused]] Arguments... args) {
        derived().visit_expr(node, args...);
    }

    HAMMER_VISITOR_DECL void visit_index_expr(
        [[maybe_unused]] IndexExpr* node, [[maybe_unused]] Arguments... args) {
        derived().visit_expr(node, args...);
    }

    HAMMER_VISITOR_DECL void visit_literal(
    ...
    HAMMER_VISITOR_DECL void visit_map_literal(
    ...
    HAMMER_VISITOR_DECL void visit_set_literal(
    ...
    HAMMER_VISITOR_DECL void visit_return_expr(
