// Automatically generated by ./utils/generate-ast at 2020-01-09 20:14:31.048862.
...
public:
    ...
    void init(const NodePtr<Expr>& value);
    const NodePtr<Expr>& init() const;
...
public:
    ...
    void vars(const NodePtr<VarList>& value);
    const NodePtr<VarList>& vars() const;
...
public:
    ...
    void var(const NodePtr<VarDecl>& value);
    const NodePtr<VarDecl>& var() const;
...
public:
    ...
    void bindings(const NodePtr<BindingList>& value);
    const NodePtr<BindingList>& bindings() const;
...
public:
    ...
    HAMMER_VISITOR_DECL void
    visit_binding([[maybe_unused]] const NodePtr<Binding>& node,
        [[maybe_unused]] Arguments... args) {
        derived().visit_node(node, args...);
    }

    HAMMER_VISITOR_DECL void
    visit_tuple_binding([[maybe_unused]] const NodePtr<TupleBinding>& node,
        [[maybe_unused]] Arguments... args) {
        derived().visit_binding(node, args...);
    }

    HAMMER_VISITOR_DECL void
    visit_var_binding([[maybe_unused]] const NodePtr<VarBinding>& node,
        [[maybe_unused]] Arguments... args) {
        derived().visit_binding(node, args...);
    }

    HAMMER_VISITOR_DECL void
    visit_binding_list([[maybe_unused]] const NodePtr<BindingList>& node,
        [[maybe_unused]] Arguments... args) {
        derived().visit_node(node, args...);
    }
    ...
    HAMMER_VISITOR_DECL void visit_tuple_member_expr(
        [[maybe_unused]] const NodePtr<TupleMemberExpr>& node,
        [[maybe_unused]] Arguments... args) {
        derived().visit_expr(node, args...);
    }
    ...
    HAMMER_VISITOR_DECL void
    visit_var_list([[maybe_unused]] const NodePtr<VarList>& node,
        [[maybe_unused]] Arguments... args) {
        derived().visit_node(node, args...);
    }
