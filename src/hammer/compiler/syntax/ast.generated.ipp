// Automatically generated by ./utils/generate-ast at 2020-01-09 20:14:31.056579.
...
#define HAMMER_VISIT_CASE(CaseType, case_function)                        \
    case NodeType::CaseType: {                                            \
        if constexpr (std::is_base_of_v<T, CaseType>) {                   \
            return visitor.case_function(static_ref_cast<CaseType>(node), \
...
#define HAMMER_VISIT_CASE(CaseType)                           \
    case NodeType::CaseType: {                                \
        if constexpr (std::is_base_of_v<T, CaseType>) {       \
            return callback(static_ref_cast<CaseType>(node)); \
        }                                                     \
        break;                                                \
    }
