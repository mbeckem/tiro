// Automatically generated by ./utils/generate-ast at 2020-01-13 20:41:19.675355.
...
#define HAMMER_VISIT_CASE(CaseType, case_function)                            \
    case NodeType::CaseType: {                                                \
        ...
        HAMMER_VISIT_CASE(FormatStringExpr, visit_format_string_expr)
...
#define HAMMER_VISIT_CASE(CaseType)                     \
    case NodeType::CaseType: {                          \
        ...
        HAMMER_VISIT_CASE(FormatStringExpr)
...
template<>
struct NodeTraits<FormatStringExpr> {
    static constexpr bool is_abstract = false;

    static constexpr NodeType node_type = NodeType::FormatStringExpr;

    template<typename Visitor>
    static void traverse_children(FormatStringExpr* node, Visitor&& visitor) {
        NodeTraits<Expr>::traverse_children(node, visitor);
    ...
    template<typename Transform>
    static void
    transform_children(FormatStringExpr* node, Transform&& transform) {
        NodeTraits<Expr>::transform_children(node, transform);
