// Automatically generated by ./utils/generate-ast at 2020-01-05 16:45:28.743268.
...
void Binding::init(const NodePtr<Expr>& value) {
    init_ = value;
}

const NodePtr<Expr>& Binding::init() const {
    return init_;
}
...
void TupleBinding::vars(const NodePtr<VarList>& value) {
    vars_ = value;
}

const NodePtr<VarList>& TupleBinding::vars() const {
    return vars_;
}
...
void VarBinding::var(const NodePtr<VarDecl>& value) {
    var_ = value;
}

const NodePtr<VarDecl>& VarBinding::var() const {
    return var_;
}
...
void TupleMemberExpr::inner(const NodePtr<Expr>& value) {
    inner_ = value;
}

const NodePtr<Expr>& TupleMemberExpr::inner() const {
    return inner_;
}
...
void DeclStmt::bindings(const NodePtr<BindingList>& value) {
    bindings_ = value;
}

const NodePtr<BindingList>& DeclStmt::bindings() const {
    return bindings_;
}
