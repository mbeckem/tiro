// Automatically generated by ./utils/generate-ast at 2020-01-13 20:41:19.684593.
...
std::string_view to_string(NodeType type) {
    ...
    case NodeType::DotExpr:
        return "DotExpr";
    case NodeType::FormatStringExpr:
...
FormatStringExpr::FormatStringExpr()
    : Expr(NodeType::FormatStringExpr)
    , items_() {}

FormatStringExpr::~FormatStringExpr() {}

void FormatStringExpr::items(ExprList* value) {
    items_.reset(value);
}

ExprList* FormatStringExpr::items() const {
    return items_;
}
