...
class VM final : public Wrapper<tiro_vm, tiro_vm_free> {
    using Wrapper::Wrapper;
};

class Frame final : public Wrapper<tiro_frame, tiro_frame_free> {
    using Wrapper::Wrapper;
};

class Compiler final : public Wrapper<tiro_compiler, tiro_compiler_free> {
    using Wrapper::Wrapper;
};

class Module final : public Wrapper<tiro_module, tiro_module_free> {
    using Wrapper::Wrapper;
};

class Error final : public Wrapper<tiro_error, tiro_error_free> {
public:
    using Wrapper::Wrapper;
