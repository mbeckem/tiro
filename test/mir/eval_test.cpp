...
TEST_CASE("Constant evaluation should support addition", "[eval-mir]") {
...
TEST_CASE("Constant evaluation should support subtraction", "[eval-mir]") {
...
TEST_CASE("Constant evaluation should support multiplicaton", "[eval-mir]") {
...
TEST_CASE("Constant evaluation should support division", "[eval-mir]") {
...
TEST_CASE("Constant evaluation should support remainder", "[eval-mir]") {
...
TEST_CASE("Constant evaluation should support powers", "[eval-mir]") {
...
TEST_CASE("Constant evaluation should support left shift for integers",
    "[eval-mir]") {
...
TEST_CASE("Constant evaluation should support bitwise or for integers",
    "[eval-mir]") {
...
TEST_CASE("Constant evaluation should support equality", "[eval-mir]") {
    ConstantPool c;
...
TEST_CASE("Constant evaluation should support inequality", "[eval-mir]") {
    ConstantPool c;
...
TEST_CASE("Constant evaluation should support unary plus", "[eval-mir]") {
...
TEST_CASE("Constant evaluation should support unary minus", "[eval-mir]") {
...
TEST_CASE("Constant evaluation should support bitwise not", "[eval-mir]") {
...
TEST_CASE("Constant evaluation should support logical not", "[eval-mir]") {
...
TEST_CASE(
    "Constant evaluation should support string formatting", "[eval-mir]") {
    ConstantPool c;
