...
ModuleMember = TaggedUnion(
    ...
    members=[
        ...
        UnionMemberStruct(
            ...
            members=[
                StructMember("name", "InternedString", doc="The name of the variable.")
            ],
        ),
        UnionMemberStruct(
            name="Function",
...
Terminator = TaggedUnion(
    ...
    members=[
        ...
        UnionMemberStruct(
            ...
            members=[StructMember("target", "BlockID", doc="The jump target."),],
        ),
        UnionMemberStruct(
            name="Branch",
            doc="A conditional jump with two successor blocks.",
            members=[
                StructMember("type", "BranchType", doc="The kind of conditional jump."),
                StructMember("value", "LocalID", doc="The value that is being tested."),
                StructMember(
    ...
    members=[
        ...
        UnionMemberStruct(
            ...
            members=[
                ...
                StructMember("index", "u32", doc="Index into the environment."),
            ],
        ),
        UnionMemberStruct(
            name="Module",
        ...
        UnionMemberStruct(
            ...
            members=[
                ...
                StructMember("name", "InternedString", doc="Field name to access."),
            ],
        ),
        UnionMemberStruct(
            name="TupleField",
            ...
            members=[
                StructMember("object", "LocalID", doc="Dereferenced tuple object."),
        ...
        UnionMemberStruct(
            ...
            members=[
                StructMember("object", "LocalID", doc="Dereferenced arraylike object."),
...
Constant = (
    TaggedUnion(
        ...
        members=[
            UnionMemberStruct("Integer", members=[StructMember("value", "i64")]),
...
RValue = TaggedUnion(
    ...
    members=[
        UnionMemberStruct(
            ...
            members=[StructMember("target", "LValue", doc="Dereferenced lvalue.")],
        ),
        UnionMemberStruct(
            name="UseLocal",
            doc="References a local variable.",
            members=[StructMember("target", "LocalID", doc="Dereferenced local.")],
        ),
        UnionMemberStruct(
            name="Phi",
            doc="Phi nodes can have one of multiple locals as their value, depending on the code path that led to them.",
            members=[StructMember("value", "PhiID", doc="The possible alternatives.")],
        ),
        UnionMemberStruct(
            name="Phi0",
        ...
        UnionMemberStruct(
            ...
            members=[
                StructMember("instance", "LocalID", doc="The object instance."),
                StructMember("method", "InternedString", doc="The name of the method."),
            ],
        ),
        UnionMemberStruct(
            name="MethodCall",
            ...
            members=[
                ...
                StructMember("args", "LocalListID", doc="List of method arguments."),
            ],
        ),
        UnionMemberStruct(
            ...
            members=[
                StructMember("parent", "LocalID", doc="The parent environment."),
                StructMember(
                    "size",
                    "u32",
        ...
        UnionMemberStruct(
            ...
            members=[StructMember("args", "LocalListID", doc="The list of values.")],
        ),
    ],
).set_format_mode("define")
